...
public class PMDSmellDetector extends SmellDetector {
	...
	public void findSmells(SmellType smellType, Map<SmellType, Set<Smell>> detectedSmells) throws Exception {
		...
		File libFolder = new File("pmd-bin-6.37.0/lib/");
	...
	private void detectCPDDuplicates(Map<SmellType, Set<Smell>> detectedSmells) throws Exception {
		File cpdBatFile = new File("pmd-bin-6.37.0/bin/cpd.bat");
	 ...
	 * @throws Exception 
	 */
	private void extractDuplicates(Document xmlDoc, Map<SmellType, Set<Smell>> detectedSmells, String projectDirectory) throws Exception {
	...
	private void detectPMDSmells(SmellType smellType, Map<SmellType, Set<Smell>> detectedSmells) throws Exception {
		File pmdBatFile = new File("pmd-bin-6.37.0/bin/pmd.bat");
		File pmdConfigFile = new File("pmd-bin-6.37.0/bin/pmd-config.xml");
		File pmdCacheFile = new File("pmd-bin-6.37.0/bin/pmd-cache.txt");
